...
struct Task T2 = { 20,0,1,SUSPENDED,4,4,TASK_FULL,0,1,0 };
struct Task T3 = { 30,0,2,SUSPENDED,3,3,TASK_FULL,0,1,0 };
struct Task T4 = { 40,0,3,SUSPENDED,6,6,TASK_NON,0,1, 0 };
struct Task T5 = { 50,0,4,SUSPENDED,8,8,TASK_FULL,0,1, 0 };
...
int main()
{
    //Testing Scheduler with tasks that are non preemptive and preemptive with different priorities second time to check interupts will not happen 
